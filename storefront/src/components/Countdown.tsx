...
/** Decorative deal countdown. Uses normal React state (a once-per-second leaf
 *  re-render is harmless) — do NOT mutate textContent on React-rendered nodes,
 *  which crashed React with "removeChild of null" on unmount during navigation. */
